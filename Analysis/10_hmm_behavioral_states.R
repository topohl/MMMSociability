...
write_output_manifest(
  ...
  primary_figures = c(
    "figures/hmm_state_occupancy.svg"
  ),
  notes = c("Downstream manuscript-ready HMM transition difference and alluvial plots are generated by script 12.")
)
...
epoch_duration_qc <- write_epoch_duration_qc(hmm_dat, output_dir, metric_source = "10_hmm_behavioral_states", bin_size_sec = infer_bin_size_sec(hmm_dat))
